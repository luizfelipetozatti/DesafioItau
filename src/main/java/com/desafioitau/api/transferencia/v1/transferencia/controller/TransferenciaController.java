...
public class TransferenciaController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "500", description = MessagesConstants.MSG_SERVICO_INDISPONIVEL),
            @ApiResponse(responseCode = "406", description = MessagesConstants.MSG_CONTA_INATIVA),
            @ApiResponse(responseCode = "406", description = MessagesConstants.MSG_LIMITE_DIARIO_ZERADO),
            @ApiResponse(responseCode = "406", description = MessagesConstants.MSG_SALDO_INDISPONIVEL),
            @ApiResponse(responseCode = "406", description = MessagesConstants.MSG_LIMITE_DIARIO_INSUFICIENTE),
            @ApiResponse(responseCode = "406", description = MessagesConstants.MSG_TENTATIVAS_EXCEDIDAS),
    } )
    public ResponseEntity<String> efetuarTransferencia(@RequestBody TransferenciaRequestDTO transferenciaRequestDTO) throws Exception {
